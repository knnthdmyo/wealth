...
export default function LoginPage() {
  ...
  useEffect(() => {
    // Load keep signed in preference from localStorage
      ...
      <div className="relative z-10 flex flex-1 items-center justify-center px-4 pt-20 pb-8">
        <div className="w-full max-w-[420px] space-y-6">
          ...
          <div className="text-center text-white mb-8">
            ...
            <p className="text-teal-50">Track your net worth in real time</p>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <label htmlFor="keepSignedIn" className="text-sm text-slate-600 dark:text-slate-400">
              Keep me signed in
            </label>
          </div>
        ...
        <p className="text-center text-sm text-slate-600 dark:text-slate-400">
          New here?{" "}
          <Link className="font-semibold text-teal-600 dark:text-teal-400" href="/register">
            Create an account
          </Link>
        </p>
        </div>
